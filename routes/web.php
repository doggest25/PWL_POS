...
Route::get('admin/manage', [KategoriController::class, 'index'])->name('kategori.index');
Route::get('admin/home', function (){
    return view('welcome');
});
Route::get('admin/level', [LevelController::class, 'index'])->name('level.create');
Route::post('/admin/level', [LevelController::class, 'store'])->name('level.store');
